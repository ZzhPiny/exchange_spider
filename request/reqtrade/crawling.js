...
// 获取预披露交易
const getBJPrePublish = require("./prepublish.bj.js");
const getSHPrePublish = require("./prepublish.sh.js");
const getTJPrePublish = require("./prepublish.tj.js");
const getCQPrePublish = require("./prepublish.cq.js");

// 获取股权交易
const getBJStockRights = require("./stockrights.bj.js");
const getSHStockRights = require("./stockrights.sh.js");
const getTJStockRights = require("./stockrights.tj.js");
const getCQStockRights = require("./stockrights.cq.js");

// 获取增资扩股交易
const getBJIncreasesStock = require("./increasesstock.bj.js");
const getSHIncreasesStock = require("./increasesstock.sh.js");
const getTJIncreasesStock = require("./increasesstock.tj.js");
const getCQIncreasesStock = require("./increasesstock.cq.js");

// 获取实物交易
const getBJMaterialObject = require("./materialobj.bj.js");
const getSHMaterialObject = require("./materialobj.sh.js");
const getTJMaterialObject = require("./materialobj.tj.js");
const getCQMaterialObject = require("./materialobj.cq.js");
